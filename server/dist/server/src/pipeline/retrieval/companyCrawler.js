...
export async function crawlCompany(companyUrl) {
    ...
    for (const link of firstPassLinks) {
        if (fetchedUrls.has(link.url) || fetchedUrls.size >= MAX_TOTAL_PAGES)
            continue;
        ...
        const isHiringPage = contentLower.includes('interview process') ||
...
//# sourceMappingURL=companyCrawler.js.map