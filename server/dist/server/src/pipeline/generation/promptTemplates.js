...
export const JD_EXTRACTION_USER = (jd) => `<job_description_data>\n${jd}\n</job_description_data>`;
// ─── Company Brief ─────────────────────────────────────────────
...
export const COMPANY_BRIEF_USER = (pages, discussions) => {
...
export const QUESTION_GEN_SYSTEM = (category, hiringContext) => `You are an expert interview coach generating ${category} interview questions.
...
export const QUESTION_GEN_USER = (requirements, startId, category) => {
...
export const GAP_FILL_USER = (uncoveredRequirements, startId) => {
...
export const FLASHCARD_USER = (requirements, questions, startId) => {
